...
class EmployeesWindow:
    ...
    def __init__(self):
        ...
        self.lbox_data_rows = tk.Listbox(
            self.frame,
            selectmode="single",
            activestyle="none",
    ...
    def add_record_callback(self, added_data_row: EmployeeDataObject):
        ...
        self.data_rows.append(added_data_row.get_full_name())
...
class EmployeeWindow:
    # Конструктор
    def __init__(
        self, add_new: bool, data_row: EmployeeDataObject, parent: EmployeesWindow
    ):
        if add_new:
        ...
        lbl_first_name = tk.Label(
            self.window, text="Имя:", font=("Helvetica", 10, "bold")
        )
        ...
        # Добавление полей ввода
        lbl_middle_name = tk.Label(
            self.window, text="Отчество:", font=("Helvetica", 10, "bold")
        )
        ...
        # Добавление полей ввода
        lbl_last_name = tk.Label(
            self.window, text="Фамилия:", font=("Helvetica", 10, "bold")
        )
        ...
        # Добавление полей ввода
        lbl_department = tk.Label(
            self.window, text="Отдел:", font=("Helvetica", 10, "bold")
        )
        lbl_department.place(x=20, y=190)

        self.cbo_department = ttk.Combobox(self.window, font=("Helvetica", 10, "bold"))
        self.init_combobox()
        # Запрет на ввода произвольных значений
    ...
    # Функция сохранение записи и закрытия этого окна
    def save(self):
    ...
    # Функция закрытия этого окна без сохранение записи
    def close(self):
        self.window.destroy()
    ...
    def collect_from_controls(self):
        ...
        self.data_row.department_id = str(
            self.get_id_from_combobox(self.cbo_department.get())
        )
