...
class EmployeesReportWindow:
    ...
    def __init__(self):
        ...
        btn_close = tk.Button(self.window, text="Закрыть", font=('Helvetica', 10, 'bold'),
    ...
    def get_report_text(self):
        ...
        current_deparments_name = "c46f4954-43ae-477c-adf2-1fd2da5cfd96"
        for data_row in data_rows:
            # Если новый отдел, добавляется заголовок группы
            if data_row.departments_id != current_deparments_name:
                report_text += data_row.departments_name + os.linesep
                current_deparments_name = data_row.departments_id
            # Добавляется запись
